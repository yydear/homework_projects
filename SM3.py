...
IV="7380166f 4914b2b9 172442d7 da8a0600 a96f30bc 163138aa e38dee4d b0fb0e4e"#IV初始值设定
...
def out_hex(list1):#输出十六进制
    for i in list1:
        print("%08x" % i)
    print("\n")
 
def rotate_left(a, k):#对a循环左移k位
    k = k % 32
...
def CF(V_i, B_i):#迭代压缩CF函数
    ...
    """
    #运用以上函数实现CF，迭代64轮，这里我们假设只运行16轮，对其缩减轮数
    for j in range(0, 16):
...
#------------------------------------------------------------
#我们假设reduced SM3只时迭代16轮，然后我们实现对reduce SM3的生日攻击：
